...
from src.data_gen import toID


class Encoder(nn.Module):
    def _init__(self, vocab_size, embedding_dim, hidden_dim):
        super(Encoder, self).__init__()
        self.hidden_dim = hidden_dim
        self.word_embeddings = nn.Embedding(vocab_size, embedding_dim, padding_idx=toID()[" "])
...
class Decoder(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim):
        ...
        self.hidden_dim = hidden_dim
        self.word_embeddings = nn.Embedding(vocab_size, embedding_dim, padding_idx=toID()[" "])
        self.word_embeddings = nn.LSTM(embedding_dim, hidden_dim, batch_first=True)
